...
const commentIdGet = (req, res, next) => {
...
const commentIdPost = (req, res, next) => {
  res.statusCode = 403;
  res.end(
    "POST operation not supported on /comments/" + req.params.commentId
  );
};
const commentIdPut = (req, res, next) => {
  Comments.findById(req.params.commentId)
    .then(
      comment => {
        if (comment != null) {
...
const commentIdDelete = (req, res, next) => {
  Comments.findById(req.params.commentId)
    .then(
      comment => {
        if (comment != null) {
